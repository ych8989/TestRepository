...
public class Exam13CookieAndSessionController {
	...
	// public String exam05(HttpSession session) { // 세션에서 문자열 정보 가져오기
	...
	// // 세션에서 삭제해도 Model에는 남아잇을수 있다
	// // @SessionAttributes 대신 HttpSession만 이용할경우에 사용할수 있다.
