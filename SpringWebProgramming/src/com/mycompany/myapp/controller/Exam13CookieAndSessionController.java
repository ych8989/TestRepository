...
public class Exam13CookieAndSessionController {
	 ...
	 * name2 = null; Cookie[] cookies = request.getCookies(); for (Cookie cookie
	 * : cookies) { if (cookie.getName().equals("name1")) { name1 =
	 * cookie.getValue(); } else if (cookie.getName().equals("name2")) { name2 =
	 * cookie.getValue(); name2 = URLDecoder.decode(name2, "UTF-8"); } }
	 * model.addAttribute("name1", name1); model.addAttribute("name2", name2);
