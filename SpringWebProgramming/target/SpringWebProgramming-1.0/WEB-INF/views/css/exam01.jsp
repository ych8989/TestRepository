...
<html>
    ...
    <body>
        ...
        <form style="background-color: gold; border: 1px solid blueviolet; height: 50px">form 태그</form>
        ...
        <h3>인라인 태그</h3>
        <span style="background-color: greenyellow; border: 1px solid black; height: 50px;">span 태그</span>
        <span style="background-color: salmon; border: 1px solid black; height: 50px">span 태그</span>
        <img style="border: 1px solid black;" src="<%=application.getContextPath()%>/resources/image/NY.JPG" height="50px"/>
