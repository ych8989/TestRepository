...
<html>
	...
	<body>
		...
		<h4 style="background-color:coral; border: 1px solid black; height: 50px ">h태그</h4>
	...
	<h3>인라인 태그</h3>
	<span style="background-color:gold; border: 1px solid black; height: 50px ">span태그</span>
	<span style="background-color:skyblue; border: 1px solid black; height: 50px ">span태그</span>	
	<img style="border: 1px solid black;" src="/WebApplication/resoures/image/jeep.png" height="50"/>
