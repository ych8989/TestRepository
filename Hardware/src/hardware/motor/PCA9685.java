...
public class PCA9685 {
    ...
    private PCA9685() throws Exception {
        ...
        //0x40:PCA9685 모듈의 I2C 장치번호        
        //PWM주파수를 50Hz로 설정 ( SG90 Servo Motor 가 50Hz에서 동작하기 때문 )
        gpioProvider = new PCA9685GpioProvider(i2cBus, 0x40, new BigDecimal(50));
        // 한 사이클당 시간 (period):1초/Frequencey=1/50Hz =0.002s=20ms=20000us
    ...
    public static void main(String[] args) throws Exception {
        ...
        //0도로 회전
        pca9685.setDuration(PWM_00, 164);
        Thread.sleep(2000);
        //90도로 회전
