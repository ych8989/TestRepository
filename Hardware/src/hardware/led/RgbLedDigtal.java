...
public class RgbLedDigtal {
    ...
    public static void main(String[] args) throws InterruptedException {
        RgbLedDigtal test = new RgbLedDigtal(RaspiPin.GPIO_27, RaspiPin.GPIO_28, RaspiPin.GPIO_29);
        while (true) {
            test.green();
            Thread.sleep(50);
            test.red();
