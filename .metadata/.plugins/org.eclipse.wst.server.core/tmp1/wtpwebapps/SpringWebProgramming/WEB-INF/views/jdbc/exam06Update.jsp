	    ...
	    <form method="post" style="padding: 0px 20px" enctype="multipart/form-data">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="제목" name="mname" value="${member.mname}"/>
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="글쓴이" name="mwriter"value="${member.mwriter}"disabled/>
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
