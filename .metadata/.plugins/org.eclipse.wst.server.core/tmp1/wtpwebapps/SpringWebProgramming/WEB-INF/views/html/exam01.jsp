...
<html>
    ...
    <body>
        ...
        <h3>이미지 태그</h3>
        <img src="<%=application.getContextPath()%>/resources/image/NY.JPG" alt="Smiley face" width="300">
        <input type="image" src="<%=application.getContextPath()%>/resources/image/NY.JPG" width="400"/>
