            ...
            <div class="panel panel-primary panel-table animated slideInDown">
                <div class="container" style="margin-top: 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" id="title" class="floatLabel" placeholder="제목" name="btitle" value="${board.btitle}" />
                        </div>
                        <div class="controls">
                            <input type="text" id="writer" class="floatLabel" placeholder="작성자" name="bwriter" value="${board.bwriter}" />
                        </div>
                        <div class="controls">
                            <input type="text" id="price" class="floatLabel" placeholder="가격" name="bprice" value="${board.bprice}" />
                        </div>
                        <div class="controls">
                            <input type="text" id="bpassword" class="floatLabel" placeholder="비밀번호" name="bpassword" value="${board.bpassword}" />
                        </div>
                    ...
                    <div class="grid">
                        ...
                        <div class="controls">
                            <textarea name="bcontent" class="floatLabel" id="comments" placeholder="내용">${board.bcontent}</textarea>
                        </div>

                        <button type="submit" value="Submit" class="col-1-4">Submit</button>
                        <button style="margin-left: 10px;" onclick="location.href = main" class="col-1-4">Detail</button>
                    </div>
                </div>
